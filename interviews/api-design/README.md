...
| [diagrams.md](./diagrams.md) | **🎯 The one-page master diagram** — the single diagram to reproduce on the whiteboard, with its **60-second narration** and **3-minute walkthrough**, the numbers that justify it, the patterns it assembles, and the three things that break. Authored last, revised from first. |
